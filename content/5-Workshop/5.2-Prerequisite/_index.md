...
- **AWS Account**: An account with necessary permissions to provision required AWS services (S3, ECR, Lambda, API Gateway, CloudWatch, SNS, Amplify, Rekognition).
...
Open your Terminal/PowerShell and run the configuration command:
```bash
aws configure
```
