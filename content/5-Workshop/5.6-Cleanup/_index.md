...
3. Click **Actions ➔ Delete** ➔ Confirm Lambda function deletion.
...
3. Click **Manage API ➔ Delete** ➔ Confirm REST API deletion.
...
2. Select Topic NutriVision-AlarmNotifications ➔ Click **Delete**.
