...
![endpoint diagram](/FCAJ-Project/images/5-Workshop/5.5-Policy/s3-bucket-policy.png)
...
```
![test](/FCAJ-Project/images/5-Workshop/5.5-Policy/test1.png)
...
![create bucket](/FCAJ-Project/images/5-Workshop/5.5-Policy/create-bucket.png)

3. Tạo bucket thành công.

![Success](/FCAJ-Project/images/5-Workshop/5.5-Policy/create-bucket-success.png)
...
![custom policy](/FCAJ-Project/images/5-Workshop/5.5-Policy/policy2.png)

Cấu hình policy thành công.

![success](/FCAJ-Project/images/5-Workshop/5.5-Policy/success.png)
...
![error](/FCAJ-Project/images/5-Workshop/5.5-Policy/error.png)
...
![success](/FCAJ-Project/images/5-Workshop/5.5-Policy/test2.png)

Thao tác này được cho phép bởi VPC endpoint policy.

![success](/FCAJ-Project/images/5-Workshop/5.5-Policy/test2-success.png)

Sau đó chúng ta kiểm tra truy cập vào S3 bucket đầu tiên

 ```aws s3 cp test-bucket2.xyz s3://<your-1st-bucket-name>```

 ![fail](/FCAJ-Project/images/5-Workshop/5.5-Policy/test2-fail.png)
