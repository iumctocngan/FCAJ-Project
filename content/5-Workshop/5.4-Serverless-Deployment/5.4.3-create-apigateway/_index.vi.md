...
5. Xác nhận khởi tạo thành công và bấm Create resource:
...
7. Xác nhận tạo Resource thành công và bấm Create method:
...
8. Cấu hình Method Type POST và Integration Lambda:
...
9. Đấu nối hàm Lambda NutriVisionPredictor:
...
10. Bật cấu hình CORS cho Methods:
...
11. Tích chọn thông số CORS và lưu cấu hình:
...
13. Khai báo Stage prod và phát hành API:
...
14. Điều chỉnh cấu hình Stage prod:
...
16. Xác nhận thay đổi và lưu cấu hình:
    ...
    - Nhấp nút Save changes ở góc dưới cùng bên phải để áp dụng.
...
17. Lấy đường dẫn Invoke URL:
    - Vào mục Stages ➔ prod ➔ /predict ➔ POST để lấy đường dẫn Invoke URL:  
