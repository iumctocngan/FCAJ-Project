...
Push the frontend source files to your GitHub repository (`https://github.com/iumctocngan/NutriVision`).
...
5. Advance to **Review** ➔ Verify configuration and click the purple **Save and deploy** button.
